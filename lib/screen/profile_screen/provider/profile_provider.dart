...
// إضافة الحقول الجديدة للمدينة والحي والموقع
  String? selectedCity;
  String? selectedArea;
  double? latitude;
  double? longitude;

  // Getter/Setter للمدينة
 ...
 void storeAddress() {
  ...
  box.write(DITLE_KEY, ditleController.text);
  box.write(POSTAL_CODE_KEY, postalCodeController.text);
  box.write(COUNTRY_KEY, countryController.text);
  SnackBarHelper.showSuccessSnackBar('Address Stored Successfully');//Address Stored Successfully
 }
